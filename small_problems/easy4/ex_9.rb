...
# take the integer input and using a hash convert to the string representation
# use string concatenation to produce the final result ie '4' + '3' = '43'
...
def integer_to_string(integer)
  string = integer.digits.reverse.map {|num| num = STRINGS[num]}
  string.join
end  
...
#   p result.prepend(DIGITS[remainder])
#     break if number == 0
#   end
#   result
# end
